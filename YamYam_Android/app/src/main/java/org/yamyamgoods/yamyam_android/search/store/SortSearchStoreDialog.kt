...
class SortSearchStoreDialog(context: Context) : Dialog(context), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sort = SearchResultStoreFragment.instance.sort
        setView()
        setOnClickListner()
    }
    ...
    fun setOnClickListner() {
        ...
        btn_dialog_sort_confirm.setOnClickListener {
            SearchResultStoreFragment.instance.sort_flag = sort_flag
            dismiss()
        }
    }
}
